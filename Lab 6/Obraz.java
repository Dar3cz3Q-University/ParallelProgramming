...
class Obraz {
	...
	public void calculate_histogram() {
		...
		for (int i = 0; i < size_n; i++) {
			for (int j = 0; j < size_m; j++) {
				...
				// optymalna wersja obliczania histogramu, wykorzystująca fakt, że symbole w
				// tablicy
				...
				// tylko dla tej wersji sensowne jest zrównoleglenie w dziedzinie zbioru znaków
				// ASCII
				for (int k = 0; k < 94; k++) {
	...
	// uniwersalny wzorzec dla różnych wariantów zrównoleglenia - można go
	// modyfikować dla
	// różnych wersji dekompozycji albo stosować tak jak jest zapisane poniżej
	// zmieniając tylko
